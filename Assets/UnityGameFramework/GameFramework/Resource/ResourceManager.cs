...
namespace GameFramework.Resource
{
    ...
    internal sealed partial class ResourceManager : GameFrameworkModule, IResourceManager
    {
        ...
        public List<string> GetResourceAssetsName(string resourceName){
            List<string> list = new List<string>();
            foreach(KeyValuePair<string,AssetInfo> keyvalue in m_AssetInfos){
                if(keyvalue.Value.ResourceName.Name == resourceName){
                    list.Add(keyvalue.Value.AssetName);
                }
            }
            return list;
        }
