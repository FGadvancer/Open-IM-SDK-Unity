...
namespace UnityGameFramework.Editor
{
    ...
    public static class OpenFolder
    {
        ...
        [MenuItem("Tools/Open Folder/Build Path", false, 9)]
        public static void OpenFolderBuildPath()
        {
            var path = System.IO.Directory.GetCurrentDirectory() + "/Build";
            // var path = "E:\\unity\\Dawn_client\\Build";
        ...
        public static void Execute(string folder)
        {
            ...
            switch (Application.platform)
            {
                ...
                case RuntimePlatform.OSXEditor:
                    ...
                    break;
                default:
                    UnityEngine.Debug.LogError(Utility.Text.Format("Not support open folder on '{0}' platform.", Application.platform));
                    break;
            }
        }
    }
